package com.next.up.code.datacenter.ui.home.document
...
import com.next.up.code.datacenter.databinding.FragmentDocumentsBinding
...
class DocumentsFragment : BaseFragment(), AllFileAdapter.OnDeleteButtonClickListener,
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDocumentsBinding.inflate(layoutInflater)
        root = binding?.root
        return root
    }
    ...
    private fun setupMainButton() {
        binding?.apply {
            ...
            toolbar.title.text = resources.getString(R.string.text_category_document)
        }
    ...
    private fun setupFile() {
        ...
        viewModel.getAllFolder(SortType.DOCUMENT, null).observe(viewLifecycleOwner) {
            if (it.isEmpty()) {
        ...
        adapter.setOnItemClickCallback((object : AllFileAdapter.OnItemClickCallback {
            override fun onItemClicked(latestFile: LatestFile) {
                ...
                findNavController().navigate(
                    R.id.action_documentsFragment_to_driveFragment, bundle
                )
            }
        }))
    }
            ...
            .observe(viewLifecycleOwner) { responseData ->
                when (responseData) {
                    is Resource.Success -> {
                        ...
                        viewModel.getListFile("Bearer $token").observe(this@DocumentsFragment) {
                        }
                    }
